...
var Profile = function Profile() {
  ...
  var loadUserInfo = /*#__PURE__*/function () {
    var _ref = (0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(/*#__PURE__*/(0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])().m(function _callee() {
      var _data, _res$data, _u$user_id, token, res, u, _u$user_id2, _u$openid, _u$nickname, _ref2, _u$avatar_url, _u$phone, _u$phone_verified, _ref3, _u$is_member, _t;
      return (0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            token = _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().getStorageSync('access_token');
            if (token) {
              _context.n = 1;
              break;
            }
          ...
          case 1:
            ...
            return _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().request({
              url: "".concat(_config_env__WEBPACK_IMPORTED_MODULE_8__.env.apiBaseUrl, "/users/profile"),
              method: 'GET',
              header: {
          ...
          case 2:
            res = _context.v;
            u = (_data = (_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.data) !== null && _data !== void 0 ? _data : res.data;
            if (u && ((_u$user_id = u.user_id) !== null && _u$user_id !== void 0 ? _u$user_id : u.userId)) {
              dispatch((0,_store_slices_userSlice__WEBPACK_IMPORTED_MODULE_7__.setUserInfo)({
                ...
                avatarUrl: (_ref2 = (_u$avatar_url = u.avatar_url) !== null && _u$avatar_url !== void 0 ? _u$avatar_url : u.avatarUrl) !== null && _ref2 !== void 0 ? _ref2 : '',
                ...
                isMember: (_ref3 = (_u$is_member = u.is_member) !== null && _u$is_member !== void 0 ? _u$is_member : u.isMember) !== null && _ref3 !== void 0 ? _ref3 : false
              }));
            }
            _context.n = 4;
            break;
  ...
  var loadStats = /*#__PURE__*/function () {
    var _ref4 = (0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(/*#__PURE__*/(0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])().m(function _callee2() {
      var _s$total, _q$total, _c$total, token, base, header, _yield$Promise$all, _yield$Promise$all2, s, q, c, _t2;
      return (0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 1:
            base = _config_env__WEBPACK_IMPORTED_MODULE_8__.env.apiBaseUrl;
            header = {
              Authorization: "Bearer ".concat(token)
            };
            _context2.n = 2;
            return Promise.all([_tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().request({
              ...
              var _r$data$data, _r$data;
              return (_r$data$data = (_r$data = r.data) === null || _r$data === void 0 ? void 0 : _r$data.data) !== null && _r$data$data !== void 0 ? _r$data$data : {};
            }), _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().request({
              url: "".concat(base, "/quotes/list"),
              method: 'GET',
              header: header
            }).then(function (r) {
              var _r$data$data2, _r$data2;
              return (_r$data$data2 = (_r$data2 = r.data) === null || _r$data2 === void 0 ? void 0 : _r$data2.data) !== null && _r$data$data2 !== void 0 ? _r$data$data2 : {};
            }), _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().request({
              url: "".concat(base, "/contracts/list"),
              method: 'GET',
              header: header
            }).then(function (r) {
              var _r$data$data3, _r$data3;
              return (_r$data$data3 = (_r$data3 = r.data) === null || _r$data3 === void 0 ? void 0 : _r$data3.data) !== null && _r$data$data3 !== void 0 ? _r$data$data3 : {};
            })]);
          case 2:
  ...
  var handleLogin = /*#__PURE__*/function () {
    var _ref5 = (0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])(/*#__PURE__*/(0,_Users_mac_zhuangxiu_agent_backup_dev_frontend_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])().m(function _callee3() {
      var _raw$data, taroEnv, code, loginRes, res, raw, d, token, userId, statusOk, _d$openid, _d$nickname, _d$avatar_url, _d$is_member, _ref6, _errRaw$detail, errRaw, errMsg, _ref7, _ref8, _ref9, _e$data$detail, _e$data, _e$data2, msg, _t3;
        ...
        while (1) switch (_context3.p = _context3.n) {
          ...
          case 6:
            ...
            if (token && userId && statusOk) {
              _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().setStorageSync('access_token', token);
              _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().setStorageSync('user_id', userId);
              _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().setStorageSync('login_fresh_at', Date.now());
              dispatch((0,_store_slices_userSlice__WEBPACK_IMPORTED_MODULE_7__.setUserInfo)({
                userId: userId,
              ...
              errMsg = (_ref6 = (_errRaw$detail = errRaw === null || errRaw === void 0 ? void 0 : errRaw.detail) !== null && _errRaw$detail !== void 0 ? _errRaw$detail : errRaw === null || errRaw === void 0 ? void 0 : errRaw.msg) !== null && _ref6 !== void 0 ? _ref6 : typeof errRaw === 'string' ? errRaw : '登录失败';
              _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().showToast({
          ...
          case 7:
            ...
            _t3 = _context3.v;
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().hideLoading();
            msg = (_ref7 = (_ref8 = (_ref9 = (_e$data$detail = _t3 === null || _t3 === void 0 || (_e$data = _t3.data) === null || _e$data === void 0 ? void 0 : _e$data.detail) !== null && _e$data$detail !== void 0 ? _e$data$detail : _t3 === null || _t3 === void 0 || (_e$data2 = _t3.data) === null || _e$data2 === void 0 ? void 0 : _e$data2.msg) !== null && _ref9 !== void 0 ? _ref9 : _t3 === null || _t3 === void 0 ? void 0 : _t3.errMsg) !== null && _ref8 !== void 0 ? _ref8 : _t3 === null || _t3 === void 0 ? void 0 : _t3.message) !== null && _ref7 !== void 0 ? _ref7 : '登录失败，请检查网络或后端';
            _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().showToast({
  ...
  var handleLogout = function handleLogout() {
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().showModal({
      ...
      success: function success(res) {
        if (res.confirm) {
          _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().removeStorageSync('access_token');
          _tarojs_taro__WEBPACK_IMPORTED_MODULE_5___default().removeStorageSync('user_id');
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.ScrollView, {
    scrollY: true,
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.View, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.Text, {
        ...
        children: "\u6211\u7684\u6743\u76CA"
      }), isLoggedIn ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.View, {
        ...
        onClick: function onClick() {
          return navTo('/pages/report-list/index');
        },
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.Text, {
        ...
        className: "folder-item",
        onClick: function onClick() {
          return navTo('/pages/photo-gallery/index');
        },
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.Text, {
          className: "folder-icon",
          children: "\uD83D\uDCF8"
        ...
        className: "folder-item",
        onClick: function onClick() {
          return navTo('/pages/data-manage/index');
        },
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.Text, {
          className: "folder-icon",
          children: "\uD83D\uDCC1"
    ...
    }), isLoggedIn && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.View, {
