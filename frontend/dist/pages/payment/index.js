      ...
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_3___default().showModal({
        ...
        success: function success(modalRes) {
          if (modalRes.confirm && orderId > 0) {
            ...
            _services_api__WEBPACK_IMPORTED_MODULE_4__.paymentApi.confirmPaid(orderId).then(function () {
              _tarojs_taro__WEBPACK_IMPORTED_MODULE_3___default().setStorageSync('is_member', true);
              _services_api__WEBPACK_IMPORTED_MODULE_4__.userApi.getProfile().then(function (pr) {
                var _pr$data, _u$user_id;
                var u = (_pr$data = pr === null || pr === void 0 ? void 0 : pr.data) !== null && _pr$data !== void 0 ? _pr$data : pr;
                if ((_u$user_id = u === null || u === void 0 ? void 0 : u.user_id) !== null && _u$user_id !== void 0 ? _u$user_id : u === null || u === void 0 ? void 0 : u.userId) {
                  var _u$user_id2, _u$openid, _u$nickname, _ref2, _u$avatar_url, _u$phone, _u$phone_verified;
