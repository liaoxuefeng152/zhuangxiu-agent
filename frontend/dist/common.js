    ...
    return new Promise(function (resolve, reject) {
      ...
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_4___default().uploadFile({
        ...
        fail: function fail(err) {
          return reject(err instanceof Error ? err : new Error((err === null || err === void 0 ? void 0 : err.errMsg) || '网络请求失败'));
        }
      });
    });
  },
...
var designerApi = {
  ...
  uploadImage: function uploadImage(filePath, fileName) {
    return new Promise(function (resolve, reject) {
      ...
      // 构建URL和header
      var url = appendAuthToUrl("".concat(BASE_URL, "/designer/upload-image"), token, userId);
      var headers = buildAuthHeaders(token, userId);
      ...
      _tarojs_taro__WEBPACK_IMPORTED_MODULE_4___default().uploadFile({
        ...
        success: function success(res) {
          if (res.statusCode < 200 || res.statusCode >= 300) {
            var msg = "\u4E0A\u4F20\u5931\u8D25 ".concat(res.statusCode);
            try {
              var _errData$detail3, _d$3;
              var errData = typeof res.data === 'string' ? JSON.parse(res.data) : res.data;
              var d = (_errData$detail3 = errData === null || errData === void 0 ? void 0 : errData.detail) !== null && _errData$detail3 !== void 0 ? _errData$detail3 : errData === null || errData === void 0 ? void 0 : errData.msg;
              if (typeof d === 'string' && d) msg = d;else if (Array.isArray(d) && (_d$3 = d[0]) !== null && _d$3 !== void 0 && _d$3.msg) msg = d[0].msg;
              if (res.statusCode === 401) msg = '请先登录';
            } catch (_unused5) {/* keep default msg */}
            reject(new Error(msg));
            return;
          }
          try {
            var _data$data3;
            var data = typeof res.data === 'string' ? JSON.parse(res.data) : res.data;
            var out = (_data$data3 = data === null || data === void 0 ? void 0 : data.data) !== null && _data$data3 !== void 0 ? _data$data3 : data;
            resolve(out !== null && out !== void 0 && out.image_url ? out : {
              image_url: out
            });
          } catch (_unused6) {
            reject(new Error('解析失败'));
