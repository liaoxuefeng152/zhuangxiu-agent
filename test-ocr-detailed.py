...
def test_quote_upload():
    ...
    png_path = "2026年深圳住宅装修真实报价单（89㎡三室一厅，半包，中档品质）.png"
    pdf_path = "2026年深圳住宅装修真实报价单（89㎡三室一厅，半包，中档品质）.pdf"
    
    file_path = png_path if os.path.exists(png_path) else pdf_path
    file_ext = "png" if os.path.exists(png_path) else "pdf"
    ...
    print(f"📄 读取文件: {file_path} ({file_ext})")
...
def test_contract_upload():
    ...
    # 优先使用PNG图片，如果没有则使用PDF
    png_path = "深圳市住宅装饰装修工程施工合同（半包装修版）.png"
    pdf_path = "深圳市住宅装饰装修工程施工合同（半包装修版）.pdf"
